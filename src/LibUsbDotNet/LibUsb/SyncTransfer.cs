...
namespace LibUsbDotNet.LibUsb
{
    public static class SyncTransfer
    {
        ...
        public static Error TransferSync(
            DeviceHandle device,
            byte endPoint,
        ...
        {
            return TransferSync(device, endPoint, endPointType, buffer, offset, length, timeout, 0, out transferLength);
        }

        internal static unsafe Error TransferSync(
            DeviceHandle device,
            byte endPoint,
            EndpointType endPointType,
            IntPtr buffer,
            ...
            out int transferLength)
        {
            ...
            // Determine the amount of isosynchronous packets
            int numIsoPackets = 0;
