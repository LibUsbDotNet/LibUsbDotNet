...
#define LIBUSB_IOCTL_GET_REG_PROPERTY			CTL_CODE(FILE_DEVICE_UNKNOWN,0x900, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define LIBUSB_IOCTL_GET_CUSTOM_REG_PROPERTY	CTL_CODE(FILE_DEVICE_UNKNOWN,0x901, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define LIBUSB_IOCTL_SET_CUSTOM_REG_PROPERTY	CTL_CODE(FILE_DEVICE_UNKNOWN,0x902, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define LIBUSB_IOCTL_CONTROL_TRANSFER			CTL_CODE(FILE_DEVICE_UNKNOWN,0x903, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
typedef struct {
  ...
  union {
    ...
    struct
    {
        ...
        unsigned int micro;
        unsigned int nano;
        unsigned int BcdLibUsbDotNetKernelMod;
    } version;
    struct
    {
