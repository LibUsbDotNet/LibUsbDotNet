...
namespace MonoLibUsb
{
    ...
    /// </summary>
    /// <param name="transfer">The transfer previously allocated with <see cref="MonoLibUsbApi.libusb_alloc_transfer"/>.</param>
    ...
    /// <param name="user_data">User data pointer specified in <see cref="MonoLibUsbApi.libusb_set_pollfd_notifiers"/> call.</param>
    [UnmanagedFunctionPointer(MonoLibUsbApi.CC)]
