...
namespace LibUsbDotNet.Internal.LibUsb
{
    internal static class LibUsbIoCtl
    {
        ...
        public static readonly int GET_WIN_PROPERTY = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x900, METHOD_BUFFERED, FILE_ANY_ACCESS);
        ...
        public static readonly int SET_CUSTOM_REG_PROPERTY = CTL_CODE(FILE_DEVICE_UNKNOWN, 0x902, METHOD_BUFFERED, FILE_ANY_ACCESS);
